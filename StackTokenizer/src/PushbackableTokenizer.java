...
/**
 * A PushbackableTokenizer allows the user to read a token and push it back to
 * the stream from which the token was read. Tokens are assumed to be separated
 * by white space. Any number of tokens may be pushed back.
 * 
